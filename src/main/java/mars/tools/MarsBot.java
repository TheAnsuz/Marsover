        ...
        public void run() {
            ...
            do {
                if (MarsBotMoving) {
                    ...
                    try {
                        Globals.memory
                                .setWord(ADDR_WHEREAREWEX, (int) MarsBotXPosition);
                        Globals.memory
                                .setWord(ADDR_WHEREAREWEY, (int) MarsBotYPosition);
    ...
    private class MarsBotDisplay extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            for (int i = 1; i <= trackIndex; i += 2) // Index grows by two (begin-end pair)
            {
                ...
                try {
                    g2
                            .drawLine((int) arrayOfTrack[i - 1].getX(), (int) arrayOfTrack[i - 1]
                                    .getY(),
                                    (int) arrayOfTrack[i].getX(), (int) arrayOfTrack[i]
                                    .getY());
