...
public class TomasuloP4 extends Tomasulo_implementado
{
    ...
    protected boolean UpdatePipeline() {
        ...
        if (this.emitiendoIncorrectas && retornoIssue) {
            ...
            try {
                ...
                Logger.getLogger(TomasuloP4.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public String toString() {
        return "Tomasulo con especulaci\u00f3n (P4). Predictor: BTB de " + Tomasulo_conf.NUM_BTB_ENTRIES + " entradas\n" + super.toString();
    }
}
