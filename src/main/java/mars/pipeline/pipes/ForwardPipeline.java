...
public class ForwardPipeline extends StaticPipe
{
    ...
    public ForwardPipeline(final Stage st, final BranchPredictor.BranchPredictor_type bp) {
        super(5, st, bp);
